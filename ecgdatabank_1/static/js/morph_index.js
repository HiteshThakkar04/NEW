...
const arrhythmiaDict = {
    'Myocardial Infarction': ['T-wave abnormalities', 'Inferior MI', 'Lateral MI', 'Right Bundle Branch Block', 'Left Bundle Branch Block'],
    'Atrial Fibrillation & Atrial Flutter': ['afib', 'aflutter'],
    'Blocks': ['I Degree', 'II Degree', 'III Degree'],
    ...
    'Ventricular Fibrillation and Asystole': ['vfib_vfl', 'null'],
    'Noise': ['Noise'],
    'Others': ['Others'],
    'LBBB & RBBB':['LBBB','RBBB']
};
